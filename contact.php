...
<div class="row">
    ...
    <div class="card">
            <div class="card-body py-4">
                ...
                <form action="" id="inquiry-form" onsubmit="return validateForm()">
    ...
    <input type="tel" class="form-control" id="contact" pattern="[0-9]{10}" minlength="10" maxlength="10" name="contact" required>
</div>
